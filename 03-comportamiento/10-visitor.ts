...
class ChildVisitor implements Visitor {
  ...
  visitFerrisWheel(ferrisWheel: FerrisWheel): void {
    console.log(
      `Niño en la Noria: Precio con descuento de ${
...
class AdultVisitor implements Visitor {
  ...
  visitFerrisWheel(ferrisWheel: FerrisWheel): void {
    console.log(
      `Adulto en la Noria: Precio con descuento de ${ferrisWheel.getPrice()}€`,
    );
  }
}
...
class SeniorVisitor implements Visitor {
  ...
  visitFerrisWheel(ferrisWheel: FerrisWheel): void {
    console.log(
      `Adulto mayor en la Noria: Precio con descuento de ${
...
function main() {
  ...
  console.log(`Noria: ${new FerrisWheel().getPrice()}`);
