...
class ElectricCar implements Vehicle {
  assemble(): void {
    console.log('%cEnsamblado un coche eléctrico', COLORS.green);
  }
}

class GasCar implements Vehicle{
  assemble(): void {
    console.log('%cEnsamblado un coche de combustión', COLORS.orange);
  }
}

class ElectricEngine implements Engine{
  start(): void {
    console.log('%cArrancando un motor eléctrico', COLORS.blue);
  }
}

class GasEngine implements Engine{
  start(): void {
    console.log('%cArrancando un motor de combustión', COLORS.red);
  }
}
