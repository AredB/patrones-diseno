...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    if ( !DatabaseConnection.instance ) {
      ...
      console.log(`%cConexión a la base de datos establecida`, COLORS.blue);
    }
  ...
  public connect(): void {
    ...
    this.connected = true;
    console.log(`%cConexión a la base de datos activa`, COLORS.green);
  }

  // Método para desconectar de la base de datos
  public disconnect(): void {
    if ( this.connected ) {
      console.log(`%cConexión a la base de datos cerrada`, COLORS.red);
